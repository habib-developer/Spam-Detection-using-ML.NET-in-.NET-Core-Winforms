...
namespace Spam_Detection_WinformsML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"G:\C# Corner Stuff\Spam Detection Winforms\SMSSpamCollection.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\mhabi\AppData\Local\Temp\MLVSTools\Spam Detection WinformsML\Spam Detection WinformsML.Model\MLModel.zip";
